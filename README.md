# hotel bookings etl
Repo created to store source code of data engineering encompassing synthetic data source preparation, data modeling, change data capture configuration, data processing logic development and testing
