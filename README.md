# hotel bookings etl
Repo containing source code of data engineering project with primary focus on ETL of hotel reservation data from transactional database to analytical database. Work invloved range from data source preparation, data modeling, change data capture configuration, data processing logic development and testing
